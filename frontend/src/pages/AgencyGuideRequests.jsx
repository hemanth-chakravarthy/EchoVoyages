...
import { FaInbox, FaPaperPlane, FaClock, FaCheckCircle, FaTimesCircle, FaBox, FaUserTie, FaCalendarAlt, FaEye, FaCommentAlt } from 'react-icons/fa';
    ...
    return (
      <div className="min-h-screen bg-[#f3f6f8] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-medium">Loading guide requests...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-[#0a66c2]">Guide Requests</h1>
          </div>
          <p className="text-gray-600 ml-9">Manage your incoming and outgoing guide requests</p>
        </div>
