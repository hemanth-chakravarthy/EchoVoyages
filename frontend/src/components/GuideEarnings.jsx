    ...
    const fetchEarningsData = async () => {
      ...
      try {
        ...
        const monthlyResponse = await axios.get(
          `${apiUrl}/guides/${guideId}/monthly-earnings?year=${currentYear}`
        );
  ...
  return (
    ...
    >
      <div className="card-body">
        <h2 className="card-title text-3xl mb-6 text-[#1a365d] text-center">
          My Earnings
        </h2>
        ...
        <div className="stats shadow mb-6">
          <div className="stat">
            ...
            <div className="stat-value text-[#4169E1]">
          ...
          <div className="stat">
            ...
            <div className="stat-value text-green-500">
              ₹{earnings.received?.toFixed(2) || "0.00"}
            </div>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-xl font-semibold mb-4 text-[#2d3748]">
            Payment History
          </h3>
